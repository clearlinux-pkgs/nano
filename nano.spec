...
Version  : 8.4
Release  : 97
URL      : https://www.nano-editor.org/dist/v8/nano-8.4.tar.gz
Source0  : https://www.nano-editor.org/dist/v8/nano-8.4.tar.gz
Source1  : https://www.nano-editor.org/dist/v8/nano-8.4.tar.gz.asc
...
%setup -q -n nano-8.4
cd %{_builddir}/nano-8.4
%patch -P 1 -p1
pushd ..
cp -a nano-8.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743603875
