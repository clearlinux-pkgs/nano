...
Version  : 8.3
Release  : 96
URL      : https://www.nano-editor.org/dist/v8/nano-8.3.tar.gz
Source0  : https://www.nano-editor.org/dist/v8/nano-8.3.tar.gz
Source1  : https://www.nano-editor.org/dist/v8/nano-8.3.tar.gz.asc
...
%setup -q -n nano-8.3
cd %{_builddir}/nano-8.3
%patch -P 1 -p1
pushd ..
cp -a nano-8.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735088627
